...
<!-- version-check: Matplotlib 3.10.9, 3.11.0rc1, checked 2026-04-28 -->
...
### 13.2 Matplotlib 3.11（预览版 3.11.0rc1，2026-04-25）

3.11.0rc1 刚刚发布，是一个**重大版本**，核心变化是文本和字体处理的完全重构。
...
> ⚠️ 待确认：3.11.0 正式版预计 2026 年 5-6 月发布。由于字体渲染栈更新，文本渲染结果可能与之前版本不完全一致，使用 Matplotlib 做测试的项目可能需要调整容差。

**2026 年 Python 可视化方案选型：**

| 场景 | 推荐方案 | 说明 |
|------|---------|------|
| 学术论文/出版物 | Matplotlib 3.10 | 最精确的输出控制 |
