...
| 传输层 | stdio/Streamable HTTP | HTTP/JSON-RPC/gRPC | HTTP REST | HTTP/DID |
| 身份认证 | OAuth 2.1 | Signed Agent Cards + OAuth 2.0 | API Key | DID |
| Agent 发现 | MCP Registry（新兴） | Agent Card | 无 | 注册表 |
